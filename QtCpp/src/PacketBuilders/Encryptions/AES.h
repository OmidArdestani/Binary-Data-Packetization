 ...
 * https://github.com/SergeyBel/AES/blob/master/src/AES.h
 * ***************************/
...
{
public:
    enum class EAESKeyLength { AES_128, AES_192, AES_256 };

public:
    CAES(const EAESKeyLength key_length = EAESKeyLength::AES_128);
    CAES(const EAESKeyLength key_length, unsigned char key[]);
...
private:
    EAESKeyLength AESKeyLength      = EAESKeyLength::AES_128;
